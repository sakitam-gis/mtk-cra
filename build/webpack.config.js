...
const styleUtils = require('./styles');
...
module.exports = function (webpackEnv) {
  ...
  return {
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
            ...
            ...styleUtils.getStyleRules(isEnvDevelopment ? {
              extract: false,
              sourceMap: true,
              addStyleSheet: true,
              usePostCSS: true,
              modules: styleUtils.modules,
            }: {
              usePostCSS: true,
              extract: true,
              sourceMap: false,
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          {},
          {
            ...
            version: dayjs().format('MM 月 DD 日 HH:mm'),
          },
          isEnvProduction
            ? {
                minify: {
      ...
      isEnvProduction && useAnalyze && new BundleAnalyzerPlugin({
        analyzerMode: 'static', // One of: `server`, `static`, `json`, `disabled`|Default: `server`
      }),
      // @link: https://www.npmjs.com/package/progress-bar-webpack-plugin
